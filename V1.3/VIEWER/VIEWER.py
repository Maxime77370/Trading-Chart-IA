...
class display(tk.Canvas):
    ...
    def __init__(self, master):
        ...
        self.pair_all = [f for f in listdir(self.currentPath.replace("/VIEWER","") + str("/DATA/BACKUP/2021-08-31/BASE")) if isfile(join(self.currentPath.replace("/VIEWER","") + str("/DATA/BACKUP/2021-08-31/BASE"), f))]
        ...
        self.reglage_icon = PhotoImage(file=str(self.currentPath + '/img/bouton_de_reglage.png'))
        self.checkbox_on_icon = PhotoImage(file=str(self.currentPath + '/img/checkbox_on.png'))
        self.checkbox_off_icon = PhotoImage(file=str(self.currentPath + '/img/checkbox_off.png'))
        self.croix_icon = PhotoImage(file=str(self.currentPath + '/img/croix.png'))
    ...
    def load_new_pair(self):
        self.path = self.currentPath.replace("/VIEWER","") + str("/DATA/BACKUP/2021-08-31/BASE/") + str(self.pair_all[self.n_pair]) #créeation de la direction du fichier.
